...
.data
    ...
    startStr db "Program is started$"
    endStr db "Program is ended", '$'
    badDirStr db "Open directory error. Error code: ", '$'
    reallocErrStr db "Error relocation memory. Error code: ", '$'
    runErrStr db "Error running other program. Error code: ", '$'
    clError db "Wrond command line arguments", '$'
    endl db 10, 13, '$'
